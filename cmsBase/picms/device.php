...
if (isset($_POST['save'])) {
	deviceInsert($device, $isActive);
}
if (isset($_POST['update'])) {
	deviceUpdate($deviceID, $device, $isActive);
}
...
if (isset($_POST['save']) || isset($_POST['update']) || isset($_POST['delete'])) {
	...
	header('location: device-list.php?msg=' . $msg);
}
?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="content">
				<header class="page-header">
					<div class="d-flex align-items-center">
						<div class="mr-auto">
							<h1 class="separator">Aparelho</h1>
				...
				<section class="page-content container-fluid">
					<div class="row">
						<div class="col-8">
							<div class="card">
								<h5 class="card-header">Dados do Aparelho</h5>
								<form method="post">
									<input type="hidden" name="deviceID" value="<?php echo $deviceID; ?>">
									<div class="card-body">
										<div class="form-group">
											<label for="exampleInputNome">Nome</label>
											<input type="text" class="form-control" name="device" value="<?php echo $device; ?>">
										</div>
										<div class="form-group">
											<div class="col-12">
