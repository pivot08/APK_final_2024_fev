							...
							<div class="card">
								...
								<div class="card-body">
									<table id="bs4-table" class="table table-striped table-bordered" style="width:100%">
										...
										<tbody>
											<?php
											$result = operatorValueByUserList($_SESSION['user']['UserID']);
											while ($row = mysqli_fetch_array($result)) { ?>
												<tr>
													<td>
														<?php echo $row['OperatorValueID']; ?>
													</td>
													<td>
													...
													<td><a
															href="operator-value.php?id=<?php echo $row['OperatorValueID']; ?>">
															<?php echo $row['PlanDetail']; ?>
														</a>
													</td>
													<td>
														<?php echo $row['DeviceValue']; ?>
													</td>
													<td>
