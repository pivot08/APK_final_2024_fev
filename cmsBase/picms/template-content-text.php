			...
			<div class="content">
				...
				<section class="page-content container-fluid">
					<div class="row">
						<div class="col-8">
							<div class="card">
								<form method="post" action="template-content.php?pageTypeID=<?php echo $pageTypeID; ?>"
									...
									<div class="card-body">
										<div class="form-group">
											...
											<input type="text" name="TemplateContent" class="form-control"
												value="<?php echo $templateContent; ?>" required>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<span style="font-size:12px">obs.: ao deixar o template vazio, o conteúdo será exibido
												em todas as páginas</span>
										...
										<div class="form-group">
											...
											<input type="file" id="file-input-photo" name="xfiles[Media]"
												accept=".jpg, .jpeg, .png, .mp4" <?php echo $media != '' ? '' : 'required'; ?>>
											<div class="file-name-photo">
												<?php echo $media != '' ? $media : ''; ?>
											</div>
										</div>
										<div class="form-group">
											<label for="input">Título exíbido no conteúdo</label>
										...
										<div class="form-group">
											...
											<select class="form-control" name="ContentOrientationID">
												<option value="">Selecione</option>
												<?php
												$result = contentOrientationList();
												while ($row = mysqli_fetch_array($result)) { ?>
													<option value="<?php echo $row['ContentOrientationID']; ?>" <?php if ($row['ContentOrientationID'] == $contentOrientationID) {
															echo 'selected';
														} ?>>
														<?php echo $row['ContentOrientation']; ?>
													</option>
												<?php } ?>
											</select>
										</div>
										...
										<div class="form-group">
											<label for="input">Ajuste de posição do texto - do topo</label>
											<input type="number" name="PositionTop" class="form-control"
												value="<?php echo $positionTop; ?>">
										</div>
										<div class="form-group">
