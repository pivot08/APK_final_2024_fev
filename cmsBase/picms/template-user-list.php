			...
			<div class="content">
				<header class="page-header">
					<div class="d-flex align-items-center">
						<div class="mr-auto">
							<h1 class="separator">Templates - Usuários</h1>
						</div>
					</div>
				</header>
				<section class="page-content container-fluid">
					<div class="row">
						<div class="col-12">
							<div class="card">
								<h5 class="card-header">Templates - Usuários</h5>
								<div class="card-body">
									<table id="bs4-table" class="table table-striped table-bordered" style="width:100%">
										...
										<tbody>
											<?php
											$result = operatorUserByUserList($_SESSION['user']['UserID'], 0);
											while ($row = mysqli_fetch_array($result)) { ?>
												<tr>
													...
													<td><a
															href="template-user.php?id=<?php echo $row['OperatorUserID']; ?>">
