			...
			<div class="content">
				<header class="page-header">
					<div class="d-flex align-items-center">
						<div class="mr-auto">
							<h1 class="separator">Templates</h1>
						</div>
					</div>
				</header>
							...
							<div class="card">
								...
								<div class="card-body">
									<table id="bs4-table" class="table table-striped table-bordered" style="width:100%">
										...
										<tbody>
										<?php 
										$result = templateByUserList($_SESSION['user']['UserID'], 1);
										while ($row = mysqli_fetch_array($result)) { ?>
											<tr>
												<td><?php echo $row['TemplateID']; ?></td>
												<td><?php echo $row['Application']; ?></td>
												<td><a href="operator-template.php?id=<?php echo $row['TemplateID']; ?>"><?php echo $row['Template']; ?></a></td>
												<td><?php echo $row['PageType']; ?></td>
												<td><?php echo $row['IsActive'] == 1 ? 'Sim' : 'Não'; ?></td>
											</tr>
										<?php } ?>
										</tbody>
										<tfoot>
