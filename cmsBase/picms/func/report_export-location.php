...
while ($firstDate <= $today) {
    ...
    $filename = "$reportDir/report-location_{$weekNumber}_{$year}.xls";
    ...
    fwrite($file, "Data;Regiao;UF;Cidade;Bairro;Acao;Aplicativo;Tipo;Template;Conteudo;Versao;Data Versao;Dispositivo;Modelo;Versao mais recente?\n");

    // Buscar registros da semana
    $result = getWeeklyRecordsByLocation($startDate, $endDate);
